using BudgetManageAPIGenerator.Extension;
...
namespace BudgetManageAPIGenerator.Generators
{
    ...
    public class DTOGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var classDeclarationSyntax in classDeclarationSyntaxes)
            {
                ...
                foreach (var className in arguments)
                {
                    ...
                    context.AddSource($"{originalName}/{className}", SourceText.From(generatedClass, Encoding.UTF8));
                }
            }
        }
        ...
        private string GetUsingArgument(AttributeSyntax usingSyntax, string className)
        {
            ...
            return argument.FirstOrDefault()?.Split(new[] { " > " },StringSplitOptions.None)[1];
        }
            ...
            IEnumerable<PropertyDeclarationSyntax> properties, bool useDynamic)
        {
            ...
            classBuilder.AppendLine("using GeneratedDto;");
